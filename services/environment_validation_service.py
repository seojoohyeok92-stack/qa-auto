...
KNOWN_VARIABLES: tuple[VariableSpec, ...] = (
    ...
    for name, scope in (
        ...
        ("DPS_REFRESH_INTERVAL_MINUTES", "DPS Agent"),
        ...
        ("NAVER_SYNC_ENABLED", "Naver Sync"),
        ("NAVER_AUTO_SYNC_ENABLED", "Naver Auto Sync"),
        ("NAVER_POST_ENABLED", "Naver Post"),
        ("NAVER_AUTO_POST_ENABLED", "Naver Auto Post"),
        ("NAVER_AUTO_SYNC_INTERVAL_MINUTES", "Naver Auto Sync"),
        ("NAVER_AUTO_POST_INTERVAL_MINUTES", "Naver Auto Post"),
        ("NAVER_AUTO_POST_MAX_RETRIES", "Naver Auto Post"),
        ("AUTO_POST_UNCHANGED_LEARNING_DAYS", "Learning"),
        ("DPS_SESSION_MONITOR_ENABLED", "DPS Session"),
        ("DPS_SESSION_KEEPALIVE_ENABLED", "DPS Session"),
        ("DPS_SESSION_MONITOR_INTERVAL_SECONDS", "DPS Session"),
        ("DPS_SESSION_KEEPALIVE_INTERVAL_MINUTES", "DPS Session"),
        ("DPS_SESSION_IDLE_MINUTES", "DPS Session"),
        ("DPS_SESSION_KEEPALIVE_URGENT_MINUTES", "DPS Session"),
        ("DPS_PASSIVE_IDLE_ENABLED", "DPS Session"),
        ("DPS_PASSIVE_SESSION_MONITOR_ENABLED", "DPS Session"),
        ("DPS_ON_DEMAND_CONNECT_ENABLED", "DPS Session"),
...
_BOOLEAN_NAMES = {
    ...
    "NAVER_SYNC_ENABLED", "NAVER_AUTO_SYNC_ENABLED",
    "NAVER_POST_ENABLED", "NAVER_AUTO_POST_ENABLED",
    "DPS_SESSION_MONITOR_ENABLED", "DPS_SESSION_KEEPALIVE_ENABLED",
    "DPS_PASSIVE_IDLE_ENABLED", "DPS_PASSIVE_SESSION_MONITOR_ENABLED",
...
_NONNEGATIVE_NUMBER_NAMES = {
    ...
    "NAVER_AUTO_SYNC_INTERVAL_MINUTES", "NAVER_AUTO_POST_INTERVAL_MINUTES",
    "NAVER_AUTO_POST_MAX_RETRIES", "AUTO_POST_UNCHANGED_LEARNING_DAYS",
    "DPS_SESSION_MONITOR_INTERVAL_SECONDS",
    "DPS_SESSION_KEEPALIVE_INTERVAL_MINUTES",
    "DPS_SESSION_IDLE_MINUTES",
    "DPS_SESSION_KEEPALIVE_URGENT_MINUTES",
}
